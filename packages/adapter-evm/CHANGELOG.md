...
- [#86](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/86) [`cad324d`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/cad324dd58a5d186d383072b0fa00540e83da163) Thanks [@pasevin](https://github.com/pasevin)! - Move the UIKit peer ranges onto the v3 line.
  ...
  **Why the floors are exact patch versions rather than `^3.0.0` / `^4.0.0`**
  ...
  older patch while UIKit resolves a _second_, nested copy for itself:
...
- [#77](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/77) [`d30acbb`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/d30acbb31a1bbd4c71f0fcfb1a999b3534ef63d3) Thanks [@pasevin](https://github.com/pasevin)! - Declare AGPL-3.0 consistently and add the missing LICENSE file.
...
- [#66](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/66) [`465b865`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/465b86513ad18abea53946c5d4faf3a50f2f7060) Thanks [@pasevin](https://github.com/pasevin)! - Add `hasIdentityKeyPurpose` IRS read for onboarding saga resume.
...
- [#64](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/64) [`a86996a`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/a86996a7a77e3ff2a4beebea142e16afb8f723e0) Thanks [@pasevin](https://github.com/pasevin)! - Deploy ONCHAINID identities with operator MANAGEMENT so the onboarding saga can complete.
...
- [#62](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/62) [`c880064`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/c880064bf0b17c2b12e48e103f01c477cfdeb269) Thanks [@pasevin](https://github.com/pasevin)! - Resolve `deployOnchainId` identity from the confirmed factory receipt (`WalletLinked` / `Deployed`) instead of a follow-up `getIdentity` eth_call that could miss even after confirmation.
...
- [#59](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/59) [`2ab7e85`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/2ab7e85b625dd17754ab20036a809c734578a3ef) Thanks [@pasevin](https://github.com/pasevin)! - Make the headless capability sub-paths bundleable for `platform: 'node'`.
...
- [#9](https://github.com/OpenZeppelin/openzeppelin-adapters/pull/9) [`2f6b1fc`](https://github.com/OpenZeppelin/openzeppelin-adapters/commit/2f6b1fc004d0d64a9adee20953f8867a09044354) Thanks [@pasevin](https://github.com/pasevin)! - Use AddressDisplay in AccountDisplay for tooltip and copy support
