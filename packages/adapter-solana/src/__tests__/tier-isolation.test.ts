...
describe('Solana Tier 1 isolation', () => {
  ...
  it('creates a declarative runtime without initializing deferred capabilities', () => {
    ...
    try {
      ...
      expect(runtime.networkConfig).toBe(solanaDevnet);
